...
namespace Budget.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<Budget.Models.ApplicationUser> users;
        protected RadzenDataGrid<Budget.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(Budget.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(Budget.Models.ApplicationUser user)
        {
            try
            {
