...
namespace Budget.Pages
{
    public partial class ApplicationRoles
    {
        ...
        protected IEnumerable<Budget.Models.ApplicationRole> roles;
        protected RadzenDataGrid<Budget.Models.ApplicationRole> grid0;
        ...
        protected async Task DeleteClick(Budget.Models.ApplicationRole role)
        {
            try
            {
